...
def create_lat_ctl2_msg(packer, CAN: CanBus, mode: int, path_offset: float, path_angle: float, curvature: float,
  ...
  values = {
    "LatCtl_D2_Rq": 1,                       # Mode: 0=None, 1=PathFollowingLimitedMode, 2=PathFollowingExtendedMode,
...
def create_acc_msg(packer, CAN: CanBus, long_active: bool, gas: float, accel: float, stopping: bool, actuate_brake: bool, v_ego_kph: float):
  """
  ...
  values = {
    ...
    "AccBrkPrchg_B_Rq": 0 if decel else 0,            # Pre-charge brake request: 0=No, 1=Yes
    "AccBrkDecel_B_Rq": 1 if actuate_brake else 0,    # Actuate Brakes: 0=No, 1=Yes
